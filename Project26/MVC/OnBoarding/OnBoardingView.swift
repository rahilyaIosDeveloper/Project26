...
class OnBoardingView: UIViewController {
    ...
    private let onBoardingData: [OnBoardingStruct] = [
        OnBoardingStruct(image: "first",
                         title: "Welcome to The Money lover app",
                         description: "Welcome to The Money Lover app – your new companion for managing expenses and income, all in one place. Let's get started!"),
        OnBoardingStruct(image: "second",
                         title: "Keep track of your expenses",
                         description: "Fill out your profile, share your financial interests, and set your goals."),
        OnBoardingStruct(image: "third",
                         title: "Dive into Money Lover",
                         description: "You're fully equipped to dive into the world of The Money Lover. Remember, we're here to assist you every step of the way. Ready to start? Let's go!")
    ]
